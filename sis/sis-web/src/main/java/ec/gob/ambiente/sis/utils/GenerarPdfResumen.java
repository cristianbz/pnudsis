...
//	public static final String REPORTE_RESUMEN_SALVAGUARDAS="<!DOCTYPE html >\r\n" + 
...
//		"<table  width='80%' style='margin: 0 auto;border-style: solid;border-collapse: collapse;font-size:10px;font-family: sans-serif;background-color: #0da5c4;' border='0'>\r\n" +
//		 "   <tr style='height:3px;border-color: #ffffff;'>\r\n" +
//		  "      <td style='font-weight: bold;vertical-align: baseline;text-align:right;' width: 50%'>Año:</td>\r\n" +
//		   "     <td width: 50%'>{P:proyecto} </td>\r\n" +
//		   " </tr>\r\n" +
//		   " <tr style='height:3px;border-color: #ffffff;'>\r\n" +
//		   "     <td style='font-weight: bold;vertical-align: baseline;text-align:right;'>Salvaguarda:</td>\r\n" +
//		   "     <td>{P:socioImplementador} </td>\r\n" +
//		   " </tr>\r\n" +		   
//		"</table>\r\n" +
//		"<br/>\r\n";
